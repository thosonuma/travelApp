  ...
  return [
    {
      ...
      flights: [
        { id: 'demo-f-1', transportType: 'flight' as const, direction: 'outbound', airline: 'ANA', flightNo: 'NH987', departureAirport: '羽田空港 (HND)', arrivalAirport: '石垣空港 (ISG)', date: '2026-05-02', departureTime: '09:00', arrivalTime: '12:10', seatNo: '', bookingRef: 'ABC123', notes: '' },
        { id: 'demo-f-2', transportType: 'flight' as const, direction: 'return', airline: 'ANA', flightNo: 'NH988', departureAirport: '石垣空港 (ISG)', arrivalAirport: '羽田空港 (HND)', date: '2026-05-05', departureTime: '13:30', arrivalTime: '16:40', seatNo: '', bookingRef: 'ABC124', notes: '' },
      ],
      accommodations: [
    ...
    },
    {
      ...
      flights: [
        { id: 'demo-f-3', transportType: 'flight' as const, direction: 'outbound', airline: 'ANA', flightNo: 'NH23', departureAirport: '羽田空港 (HND)', arrivalAirport: '伊丹空港 (ITM)', date: '2026-04-01', departureTime: '08:00', arrivalTime: '09:05', seatNo: '', bookingRef: 'XYZ789', notes: '' },
        { id: 'demo-f-4', transportType: 'shinkansen' as const, direction: 'outbound', airline: 'JR東海', flightNo: 'のぞみ17号', departureAirport: '新大阪駅', arrivalAirport: '京都駅', date: '2026-04-01', departureTime: '09:30', arrivalTime: '09:44', seatNo: '5号車 12番A席', bookingRef: '', notes: '' },
        { id: 'demo-f-5', transportType: 'flight' as const, direction: 'return', airline: 'ANA', flightNo: 'NH32', departureAirport: '伊丹空港 (ITM)', arrivalAirport: '羽田空港 (HND)', date: '2026-04-03', departureTime: '19:00', arrivalTime: '20:05', seatNo: '', bookingRef: 'XYZ790', notes: '' },
      ],
      accommodations: [
